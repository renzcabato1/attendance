...
<div class="modal fade" id="add_attendance{{$name.$new_date}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form  method='POST' action='add-attendance'   onsubmit="return attendance_add({{$name.$new_date}})">
                <style>
                ...
                <div class="modal-body">
                    ...
                    <div class='row'>
                        <div class='col-md-2'>
                            ...
                            <input id='start_time1{{$name.$new_date}}'  type="time" class="form-control" name="start_time"  required >
                            <p class='error' id='start_time_error1{{$name.$new_date}}'></p>
                        </div>
                        <div class='col-md-2'>
                            <label style="position:relative; top:7px;">Time Out:</label>
                            <input id='end_time1{{$name.$new_date}}'  type="time" class="form-control" name="end_time"  required >
                            <p class='error' id='end_time_error1{{$name.$new_date}}'></p>
                        </div>
                        <div class='col-md-2'>
                            <label style="position:relative; top:7px;">&nbsp;</label>
                            <div class="form-group">
                                <input style="position:relative; top:7px;" id='nextday{{$name.$new_date}}' type="checkbox"  name="nextday" class='checkbox col-sm-1' value="1"><label class="control-label col-sm-6">is Nextday</label>
                            </div>
                        </div>
                        <div class='col-md-3'>
