...
<table border='1' class="table table-striped table-bordered third" style="width:100%;" >
    ...
    <tbody>
        <tr>
            ...
            $total_gross_amount_original = $computation + $computation_nd + $computation_sh  + $computation_sh_nd + $computation_lh + $computation_lh_nd + $computation_sh_lh + $computation_sh_lh_nd - $computation_late -  $computation_undertime  ;
            ...
            $total_gross_amount_original = $computation + $computation_nd + $computation_sh  + $computation_sh_nd + $computation_lh + $computation_lh_nd + $computation_sh_lh + $computation_sh_lh_nd   ;
            $total_gross_amount_for_approval = $total_gross_amount - $total_gross_amount_original ;
            if(($date_from == '2019-09-23') && ($agency_id == 4) && ($company_id == 5) && ($location_id == 10) && ($position_id == 14))
            {
                $total_gross_amount = $computation + $computation_nd + $computation_ot + $computation_nd_ot  + $computation_rest_day_ot + $computation_rest_day_nd_ot 
                + $computation_sh + $computation_sh_nd + $computation_sh_ot + $computation_sh_nd_ot + $computation_lh + $computation_lh_nd + $computation_lh_ot + $computation_lh_nd_ot + $computation_rest_day_sh + $computation_rest_day_sh_nd
                + $computation_rest_day_sh_ot + $computation_rest_day_sh_nd_ot + $computation_rest_day_lh + $computation_rest_day_lh_nd + $computation_rest_day_lh_nd + $computation_rest_day_lh_ot + $computation_rest_day_lh_nd_ot 
                + $computation_sh_lh + $computation_sh_lh_nd + $computation_sh_nd_ot + $computation_sh_lh_nd_ot - $computation_late -  $computation_undertime;
                
                $total_gross_amount_original = $computation + $computation_nd + $computation_sh  + $computation_sh_nd + $computation_lh + $computation_lh_nd + $computation_sh_lh + $computation_sh_lh_nd - $computation_late -  $computation_undertime   ;
                $total_gross_amount_for_approval = $total_gross_amount - $total_gross_amount_original  + $computation_rest_day ;

            }
            if(($date_from == '2019-09-23') && ($agency_id == 4) && ($company_id == 1) && ($location_id == 11) && ($position_id == 11))
            {
                $total_gross_amount_for_approval = $total_gross_amount - $total_gross_amount_original + $computation_late +  $computation_undertime;
            }
